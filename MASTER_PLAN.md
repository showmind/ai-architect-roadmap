...
| KU编号 | 知识点 | 载体 | 状态 |
|--------|--------|------|------|
| L1-KU01 | 设计模式在架构中的应用（10种精选） | 互动卡片 + 代码可视化 | ✅ |
| L1-KU02 | 编码规范与 SOLID 原则 | 互动网页 + p5动画 + 测验 | ✅ |
| L1-KU03 | 数据结构与算法工程应用 | 互动网页 + p5动画 + 测验 | ✅ |
| L1-KU04 | 架构思维入门（DRY/YAGNI/KISS/Separation） | 互动网页 + p5动画 + 测验 | ✅ |
| L1-KU05 | 代码复用与模块化设计 | 互动网页 + p5动画 + 测验 | ✅ |

### Level 2 · 分布式与架构设计

| KU编号 | 知识点 | 载体 | 状态 |
|--------|--------|------|------|
| L2-KU01 | CAP 定理与 BASE 理论 | 互动网页 + p5动画 + 测验 | ✅ |
